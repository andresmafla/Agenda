...
<body>
    <div class="container">
        ...
        <form action="eliminarFecha2.php" method="POST">
            <div class="row">
                ...
                ?>
                    <table class="table table-striped">
                        ...
                        while ($arr = mysqli_fetch_array($res)) {
                            echo "<tr>";
                            echo "<td><input type='radio' name='victima' value='$arr[0]' required>
                            <input type='hidden' name='txtdes' id='txtdes' value='$arr[1]'>
                            </td>";
                            echo "<td>$arr[0]</td>";
                            echo "<td>$arr[1]</td>";
                            echo "</tr>";
